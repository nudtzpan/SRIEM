...
parser.add_argument('--hiddenSize', type=int, default=200, help='hidden state size')
parser.add_argument('--outSize', type=int, default=100, help='out state size')
...
def main():
    ...
    train_data = Data(train_data, shuffle=False, opt=opt)
